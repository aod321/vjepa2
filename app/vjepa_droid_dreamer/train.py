...
from app.vjepa_droid_dreamer.droid import init_data
from app.vjepa_droid_dreamer.transforms import make_transforms
from app.vjepa_droid_dreamer.utils import init_opt, init_video_model, load_checkpoint, load_pretrained
...
def main(args, resume_preempt=False):
    ...
    freeze_encoder = cfgs_meta.get("freeze_encoder", False)
    ...
    # -- load pretrained weights before wrapping with DDP to avoid module. prefix mismatches
    ...
    # Only wrap encoder with DDP if it has trainable parameters
